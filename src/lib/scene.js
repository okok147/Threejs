...
export const scenePresets = {
  ...
  gildedStage: {
    ...
    fog: { color: 0xf5ead8, density: 0.039 },
    glowStops: [
      [0, 'rgba(255,255,255,1)'],
      [0.22, 'rgba(239,201,143,0.9)'],
      [0.56, 'rgba(32,78,79,0.2)'],
      [1, 'rgba(245,234,216,0)'],
    ],
    motion: {
      pointer: 0.22,
      drift: 0.4,
    ...
    layout: {
      desktop: { fov: 28, cameraX: 0.16, cameraY: 0.08, cameraZ: 8.04, worldX: 0.38, worldY: 0.08 },
      compact: { fov: 34, cameraX: 0.08, cameraY: 0.34, cameraZ: 8.78, worldX: 0.18, worldY: 0.42 },
      mobile: { fov: 44, cameraX: 0, cameraY: 0.88, cameraZ: 9.44, worldX: 0, worldY: 1.22 },
    },
    aura: { color: 0xefc98f, opacity: 0.2, scale: 7.4 },
    warmAura: { color: 0x204e4f, opacity: 0.14, scale: 5, position: [-0.2, 0.1, -0.18] },
    core: {
      color: 0xfffcf4,
      emissive: 0x6a451e,
    ...
    shell: { color: 0xffffff, opacity: 0.08 },
    edges: { color: 0xfff4dd, opacity: 0.16 },
    halo: { color: 0xbf8444, opacity: 0.3 },
    haloSecondary: { color: 0x204e4f, opacity: 0.32 },
    portal: { color: 0xfffbf2, opacity: 0.08 },
    beam: { color: 0xf1e5d3, opacity: 0.06 },
    trail: { color: 0xc6a57a, opacity: 0.16 },
    dust: { color: 0xfff4dd, size: 0.022, opacity: 0.22 },
    stars: { color: 0xffffff, size: 0.028, opacity: 0.34 },
    satellites: [
      { radius: 2.14, speed: 0.5, phase: 0.16, yScale: 0.08, scale: 0.62, color: 0xefc98f },
      { radius: 2.82, speed: 0.4, phase: 2.32, yScale: 0.22, scale: 0.5, color: 0x204e4f },
      { radius: 2.36, speed: 0.7, phase: 4.48, yScale: 0.14, scale: 0.42, color: 0xffffff },
    ],
    lights: {
      ambient: { color: 0xf7f0e4, intensity: 1.5 },
      key: { color: 0xffffff, intensity: 18, distance: 28, decay: 2, position: [4.1, 3.6, 5.4] },
      fill: { color: 0xd9c7ae, intensity: 8, distance: 22, decay: 2, position: [-4.2, -1.6, 3.3] },
      warm: { color: 0x204e4f, intensity: 8, distance: 18, decay: 2, position: [-0.1, 1, 2.8] },
    },
  },
  spectralMoth: {
    toneMappingExposure: 1.04,
